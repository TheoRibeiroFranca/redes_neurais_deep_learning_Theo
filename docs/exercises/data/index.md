---
exercise: data
ai_use: "descreva o uso de IA nesta entrega, ou 'none'"
---
...
O script vive em [`code/exercise1_point_clouds.py`](https://github.com/TheoRibeiroFranca/redes_neurais_deep_learning_Theo/blob/main/docs/exercises/data/code/exercise1_point_clouds.py)
